 ...
 */
final class not_found_response_test extends route_testcase {
    public function test_basics(): void {
        $this->assertIsInt(not_found_response::get_exception_status_code());
        $this->assertEquals(404, not_found_response::get_exception_status_code());
    }
    ...
    public function test_openapi_description(): void {
        $response = new not_found_response();
